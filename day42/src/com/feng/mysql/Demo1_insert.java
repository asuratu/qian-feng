...
/**
 * @ClassName Demo1_insert
 * @Description com.feng.mysql.Demo1_insert
 * @Author AsuraTu
...
public class Demo1_insert {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        // 4. 执行 sql 语句, 获得结果
        // 4.1 定义 sql 语句
        String sql = "INSERT INTO `user` (`passport`, `password`, `nickname`, `create_at`, `update_at`) VALUES ('admin', '123', '张三2', '2023-05-24 16:23:13', '2023-05-24 16:23:15')";
